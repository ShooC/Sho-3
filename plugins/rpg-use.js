...
let handler  = async (m, { conn, command, args, usedPrefix, DevMode }) =>  {
    ...
    try {
        ...
        let msgpenuh = (pickRandom(['Nyawamu sudah penuh', 'coba deh liat inv mu, nyawamu kan dah 100 ngapai ngunain potion lagi?', 'health mu dah penuh woyy', 'udh penuh oi', 'nyawamu dah penuh :v', 'udh weh, udh penuh']))
